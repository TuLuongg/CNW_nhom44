...
const OrganizingEventDetails = lazy(() => {
  return Promise.all([
    import(
      "../pages/JoinedStudent/OrganizingEvent/OrganizingEventDetails/organizingEventDetails"
    ),
    new Promise((resolve) => setTimeout(resolve, 0)),
  ]).then(([moduleExports]) => moduleExports);
});
...
const OrganizedEventDetails = lazy(() => {
  return Promise.all([
    import(
      "../pages/JoinedStudent/OrganizedEvent/OrganizedEventDetails/organizedEventDetails"
    ),
    new Promise((resolve) => setTimeout(resolve, 0)),
  ]).then(([moduleExports]) => moduleExports);
});
